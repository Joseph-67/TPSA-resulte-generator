...
# Your data
from classes.js.subject import subjects
from classes.js.js1D import students_data, class_data
...
def create_term_sheet(ws, student, term_name, term_num, show_prev=True):
   ...
   # Merge position/remark columns
    ...
    for idx, subject in enumerate(subjects):
        ...
        # This Term Total
        ws.cell(r, cols_total).value = f"=ROUND(B{r} + C{r} + D{r}, 1)"
        ...
        if term_num == 3 and show_2nd:
            ...
            ws.cell(r, col_offset).value = f"='{sheet_2nd}'!E{r}"
            col_offset += 1
    ...
    for i in range(5):
        ...
        if term_num == 1:
            data_col = 5  # Column E (This Term Total)
        elif term_num == 2:
            data_col = 5  # Column F (Cumulative for 2nd term)
        else:  # term_num == 3
            data_col = 5  # Column G (Cumulative for 3rd term)
