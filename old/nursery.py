...
# load main template
wb = load_workbook("templates/2024_2025/SECOND_term/NURSERY TEMPLATE V1.0 (2).xlsx")
# create a worksheet
ws = wb.active
print(ws["B3"].value)

list_of_students = ST.nurseryOneDiamond
...
for x in list_of_students:
    ...
    new_sheet["B5"].value = "NURSERY ONE"
    new_sheet["F5"].value = "DIAMOND"
    ...
    data = Reference(new_sheet, min_col=7, min_row=9, max_row=24)
    cats = Reference(new_sheet, min_col=1, min_row=10, max_row=24)
    chart1.add_data(data, titles_from_data=True)
    chart1.set_categories(cats)
    # chart1.shape = 4
    new_sheet.add_chart(chart1, "A35")
    app_name = 'NURSERY1DIAMOND'
