...
gradeFive = [
  ...
  "Akobe Itopa Susan",
  "Bamidele Hephzibah Antola",
  "David Daniella Anibe",
  "Fannap Keren Nanre",
  "Bassey Olawole Godwin",
  "Okaka Kingsley Chigozim",
  "Sanusi M. Rodiat Folashade",
  "Nelson Owen-Joshua O."
]
...
js3D = [
  ...
  "Emmanuel Olan",
  "Francis Charles",
  "Ihiale Freedom Frank ",
  "Haruna  Success",
  "Kappe Jonathan Jesse",
  "Monday Fortune",
  "Otu Esther",
  "Simeon Tracy",
  "Solomon Jethro",
