...
for x in list_of_students:
    ...
    new_sheet["B5"].value = "J.S.S THREE"
    new_sheet["F5"].value = "GOLD"
    ...
    data = Reference(new_sheet, min_col=7, min_row=9, max_row=28)
    cats = Reference(new_sheet, min_col=1, min_row=10, max_row=28)
    chart1.add_data(data, titles_from_data=True)
    chart1.set_categories(cats)
    # chart1.shape = 4
    new_sheet.add_chart(chart1, "A39")
    app_name = 'JSS3GOLD'
